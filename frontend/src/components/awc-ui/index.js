 ...
 */
const br = globalThis, io = br.ShadowRoot && (br.ShadyCSS === void 0 || br.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, so = Symbol(), Mo = /* @__PURE__ */ new WeakMap();
let ni = class {
  constructor(e, r, i) {
    if (this._$cssResult$ = !0, i !== so) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (io && e === void 0) {
      ...
      i && (e = Mo.get(r)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && Mo.set(r, e));
    }
    return e;
  }
  toString() {
...
const ns = (t) => new ni(typeof t == "string" ? t : t + "", void 0, so), w = (t, ...e) => {
  ...
  if (io) t.adoptedStyleSheets = e.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet);
    ...
    const i = document.createElement("style"), o = br.litNonce;
    o !== void 0 && i.setAttribute("nonce", o), i.textContent = r.cssText, t.appendChild(i);
  }
}, jo = io ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: cs, defineProperty: ds, getOwnPropertyDescriptor: ps, getOwnPropertyNames: hs, getOwnPropertySymbols: us, getPrototypeOf: vs } = Object, Gt = globalThis, zo = Gt.trustedTypes, gs = zo ? zo.emptyScript : "", Ur = Gt.reactiveElementPolyfillSupport, je = (t, e) => t, mr = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? gs : null;
      break;
  ...
  return r;
} }, ao = (t, e) => !cs(t, e), Ro = { attribute: !0, type: String, converter: mr, reflect: !1, hasChanged: ao };
...
let me = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, r, i) {
    const { get: o, set: s } = ps(this.prototype, e) ?? { get() {
      return this[r];
    }, set(a) {
      this[r] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(je("properties"))) {
      const r = this.properties, i = [...hs(r), ...us(r)];
  ...
  _$EC(e, r) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const a = (((s = i.converter) == null ? void 0 : s.toAttribute) !== void 0 ? i.converter : mr).toAttribute(r, i.type);
  ...
  _$AK(e, r) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const a = i.getPropertyOptions(o), d = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((s = a.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? a.converter : mr;
      this._$Em = o, this[o] = d.fromAttribute(r, a.type), this._$Em = null;
    }
  }
  requestUpdate(e, r, i) {
    if (e !== void 0) {
      if (i ?? (i = this.constructor.getPropertyOptions(e)), !(i.hasChanged ?? ao)(this[e], r)) return;
      this.P(e, r, i);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (o.size > 0) for (const [s, a] of o) a.wrapped !== !0 || this._$AL.has(s) || this[s] === void 0 || this.P(s, this[s], a);
    }
    let e = !1;
    const r = this._$AL;
    try {
...
me.elementStyles = [], me.shadowRootOptions = { mode: "open" }, me[je("elementProperties")] = /* @__PURE__ */ new Map(), me[je("finalized")] = /* @__PURE__ */ new Map(), Ur == null || Ur({ ReactiveElement: me }), (Gt.reactiveElementVersions ?? (Gt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ze = globalThis, yr = ze.trustedTypes, Fo = yr ? yr.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, li = "$lit$", Wt = `lit$${Math.random().toFixed(9).slice(2)}$`, ci = "?" + Wt, fs = `<${ci}>`, ae = document, Ve = () => ae.createComment(""), qe = (t) => t === null || typeof t != "object" && typeof t != "function", di = Array.isArray, ws = (t) => di(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", Nr = `[ 	
\f\r]`, De = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Vo = /-->/g, qo = />/g, oe = RegExp(`>|${Nr}(?:([^\\s"'>=/]+)(${Nr}*=${Nr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ho = /'/g, Uo = /"/g, pi = /^(?:script|style|textarea|title)$/i, hi = (t) => (e, ...r) => ({ _$litType$: t, strings: e, values: r }), l = hi(1), Q = hi(2), pt = Symbol.for("lit-noChange"), V = Symbol.for("lit-nothing"), No = /* @__PURE__ */ new WeakMap(), ie = ae.createTreeWalker(ae, 129);
function ui(t, e) {
...
const bs = (t, e) => {
  ...
  let o, s = e === 2 ? "<svg>" : "", a = De;
  for (let d = 0; d < r; d++) {
    const c = t[d];
    let h, p, g = -1, y = 0;
    for (; y < c.length && (a.lastIndex = y, p = a.exec(c), p !== null); ) y = a.lastIndex, a === De ? p[1] === "!--" ? a = Vo : p[1] !== void 0 ? a = qo : p[2] !== void 0 ? (pi.test(p[2]) && (o = RegExp("</" + p[2], "g")), a = oe) : p[3] !== void 0 && (a = oe) : a === oe ? p[0] === ">" ? (a = o ?? De, g = -1) : p[1] === void 0 ? g = -2 : (g = a.lastIndex - p[2].length, h = p[1], a = p[3] === void 0 ? oe : p[3] === '"' ? Uo : Ho) : a === Uo || a === Ho ? a = oe : a === Vo || a === qo ? a = De : (a = oe, o = void 0);
    const _ = a === oe && t[d + 1].startsWith("/>") ? " " : "";
    s += a === De ? c + fs : g >= 0 ? (i.push(h), c.slice(0, g) + li + c.slice(g) + Wt + _) : c + Wt + (g === -2 ? d : _);
  }
...
class He {
  constructor({ strings: e, _$litType$: r }, i) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const d = e.length - 1, c = this.parts, [h, p] = bs(e, r);
    ...
    for (; (o = ie.nextNode()) !== null && c.length < d; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const g of o.getAttributeNames()) if (g.endsWith(li)) {
          const y = p[a++], _ = o.getAttribute(g).split(Wt), O = /([.?@])?(.*)/.exec(y);
          c.push({ type: 1, index: s, name: O[2], strings: _, ctor: O[1] === "." ? ms : O[1] === "?" ? ys : O[1] === "@" ? xs : Lr }), o.removeAttribute(g);
        } else g.startsWith(Wt) && (c.push({ type: 6, index: s }), o.removeAttribute(g));
        if (pi.test(o.tagName)) {
          const g = o.textContent.split(Wt), y = g.length - 1;
          if (y > 0) {
            o.textContent = yr ? yr.emptyScript : "";
            for (let _ = 0; _ < y; _++) o.append(g[_], Ve()), ie.nextNode(), c.push({ type: 2, index: ++s });
            o.append(g[y], Ve());
          }
        }
        ...
        let g = -1;
        for (; (g = o.data.indexOf(Wt, g + 1)) !== -1; ) c.push({ type: 7, index: s }), g += Wt.length - 1;
      }
      s++;
    }
  }
...
function ye(t, e, r = t, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== s && ((d = o == null ? void 0 : o._$AO) == null || d.call(o, !1), s === void 0 ? o = void 0 : (o = new s(t), o._$AT(t, r, i)), i !== void 0 ? (r._$Co ?? (r._$Co = []))[i] = o : r._$Cl = o), o !== void 0 && (e = ye(t, o._$AS(t, e.values), o, i)), e;
}
class _s {
  constructor(e, r) {
  ...
  u(e) {
    const { el: { content: r }, parts: i } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? ae).importNode(r, !0);
    ie.currentNode = o;
    let s = ie.nextNode(), a = 0, d = 0, c = i[0];
    for (; c !== void 0; ) {
      if (a === c.index) {
        let h;
        c.type === 2 ? h = new er(s, s.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (h = new Cs(s, this, e)), this._$AV.push(h), c = i[++d];
      }
...
class er {
  ...
  constructor(e, r, i, o) {
    this.type = 2, this._$AH = V, this._$AN = void 0, this._$AA = e, this._$AB = r, this._$AM = i, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, r = this) {
    e = ye(this, e, r), qe(e) ? e === V || e == null || e === "" ? (this._$AH !== V && this._$AR(), this._$AH = V) : e !== this._$AH && e !== pt && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ws(e) ? this.k(e) : this._(e);
  }
  S(e) {
  ...
  _(e) {
    this._$AH !== V && qe(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ae.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: r, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = He.createElement(ui(i.h, i.h[0]), this.options)), i);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === o) this._$AH.p(r);
    else {
      const a = new _s(o, this), d = a.u(this.options);
  ...
  k(e) {
    ...
    const r = this._$AH;
    let i, o = 0;
    for (const s of e) o === r.length ? r.push(i = new er(this.S(Ve()), this.S(Ve()), this, this.options)) : i = r[o], i._$AI(s), o++;
...
class Lr {
  ...
  constructor(e, r, i, o, s) {
    this.type = 1, this._$AH = V, this._$AN = void 0, this.element = e, this.name = r, this._$AM = o, this.options = s, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = V;
  }
  _$AI(e, r = this, i, o) {
    const s = this.strings;
    let a = !1;
    if (s === void 0) e = ye(this, e, r, 0), a = !qe(e) || e !== this._$AH && e !== pt, a && (this._$AH = e);
    else {
      const d = e;
      let c, h;
      for (e = s[0], c = 0; c < s.length - 1; c++) h = ye(this, d[i + c], r, c), h === pt && (h = this._$AH[c]), a || (a = !qe(h) || h !== this._$AH[c]), h === V ? e = V : e !== V && (e += (h ?? "") + s[c + 1]), this._$AH[c] = h;
    }
    a && !o && this.j(e);
  }
  j(e) {
...
class xs extends Lr {
  ...
  _$AI(e, r = this) {
    ...
    const i = this._$AH, o = e === V && i !== V || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive, s = e !== V && (i === V || o);
...
class u extends me {
  ...
  update(e) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = $s(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var ai;
u._$litElement$ = !0, u.finalized = !0, (ai = globalThis.litElementHydrateSupport) == null || ai.call(globalThis, { LitElement: u });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ks = { attribute: !0, type: String, converter: mr, reflect: !1, hasChanged: ao }, Os = (t = ks, e, r) => {
  const { kind: i, metadata: o } = r;
  let s = globalThis.litPropertyMetadata.get(o);
  if (s === void 0 && globalThis.litPropertyMetadata.set(o, s = /* @__PURE__ */ new Map()), s.set(r.name, t), i === "accessor") {
    const { name: a } = r;
    return { set(d) {
...
function n(t) {
  return (e, r) => typeof r == "object" ? Os(t, e, r) : ((i, o, s) => {
    const a = o.hasOwnProperty(s);
    return o.constructor.createProperty(s, a ? { ...i, wrapped: !0 } : i), a ? Object.getOwnPropertyDescriptor(o, s) : void 0;
  })(t, e, r);
}
/**
 * @license
...
let Es;
function gi(t) {
  return (e, r) => vi(e, r, { get() {
    return (this.renderRoot ?? Es ?? (Es = document.createDocumentFragment())).querySelectorAll(t);
  } });
}
const Ss = w`
    :host {
...
`;
var Ps = Object.defineProperty, As = Object.getOwnPropertyDescriptor, fi = (t, e, r, i) => {
...
`;
var Bs = Object.defineProperty, Is = Object.getOwnPropertyDescriptor, wi = (t, e, r, i) => {
...
Cr.styles = [Ls];
wi([
  n({ type: Boolean, reflect: !0, attribute: "no-divider" })
], Cr.prototype, "noDivider", 2);
Cr = wi([
  f(bi)
], Cr);
let _i = !1;
...
var Ms = Object.defineProperty, js = Object.getOwnPropertyDescriptor, rr = (t, e, r, i) => {
...
let ne = class extends u {
  ...
  update(t) {
    super.update(t), t.has("active") && this.active && (this.dispatchEvent(
...
rr([
  P("awc-segment-item-change")
], ne.prototype, "_onChangeActive", 2);
ne = rr([
  f("awc-segment-switcher-item")
], ne);
const Rs = w`
    :host{
        display: inline-block;
...
`;
var Fs = Object.defineProperty, Vs = Object.getOwnPropertyDescriptor, Br = (t, e, r, i) => {
...
let xe = class extends u {
  ...
  updated(t) {
    super.updated(t), (t.has("sliderPosition") || t.has("sliderWidth")) && this._toggleSliderVisibility();
  }
  handleSegmentItemClick(t) {
    const e = t.target;
    e && !e.active && (this.segmentSwitcherItems.forEach((r) => r.active = !1), e.active = !0, this._setSliderPositionToActiveItem(e));
  }
  _setSliderPositionToActiveItem(t) {
    this.segmentSwitcherItems.forEach((e) => e.active = !1), t.active = !0, t.active && (this.sliderPosition = t.offsetLeft, this.sliderWidth = t.offsetWidth);
  }
  _toggleSliderVisibility() {
    this._slider && (this._slider.addEventListener("transitionstart", () => {
  ...
  updateSliderPosition() {
    ...
    if (t) {
      const e = t.getBoundingClientRect(), r = this.getBoundingClientRect();
...
Br([
  Y()
], xe.prototype, "sliderPosition", 2);
Br([
  Y()
], xe.prototype, "sliderWidth", 2);
Br([
  S(".slider")
], xe.prototype, "_slider", 2);
xe = Br([
  f("awc-segment-switcher")
], xe);
const qs = w`
    :host{
      display: block;
...
`;
var Hs = Object.defineProperty, Us = Object.getOwnPropertyDescriptor, lo = (t, e, r, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Nt = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, co = (t) => (...e) => ({ _$litDirective$: t, values: e });
class po {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const et = co(class extends po {
  constructor(t) {
    var e;
    if (super(t), t.type !== Nt.ATTRIBUTE || t.name !== "class" || ((e = t.strings) == null ? void 0 : e.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(t) {
  ...
  update(t, [e]) {
    ...
    for (const s in e) {
      const a = !!e[s];
      a === this.st.has(s) || (o = this.nt) != null && o.has(s) || (a ? (r.add(s), this.st.add(s)) : (r.remove(s), this.st.delete(s)));
    }
    return pt;
  }
});
var Ws = Object.defineProperty, Gs = Object.getOwnPropertyDescriptor, nt = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Gs(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Ws(e, r, o), o;
}, xi = /* @__PURE__ */ ((t) => (t.GlobalRed2600 = "global-red-2-600", t.GlobalRed2500 = "global-red-2-500", t.GlobalOrange500 = "global-orange-500", t.GlobalYellow500 = "global-yellow-500", t.GlobalYellow300 = "global-yellow-300", t.GlobalLightGreen400 = "global-light-green-400", t.GlobalLightGreen600 = "global-light-green-600", t.GlobalGreen600 = "global-green-600", t.GlobalGreen300 = "global-green-300", t.GlobalTurquoise300 = "global-turquoise-300", t.GlobalTurquoise400 = "global-turquoise-400", t.GlobalCyan300 = "global-cyan-300", t.GlobalCyan500 = "global-cyan-500", t.GlobalBlue600 = "global-blue-600", t.GlobalBlue400 = "global-blue-400", t.GlobalDeepPurple400 = "global-deep-purple-400", t.GlobalDeepPurple600 = "global-deep-purple-600", t.GlobalPurple600 = "global-purple-600", t.GlobalPurple400 = "global-purple-400", t.GlobalRed500 = "global-red-500", t.GlobalRed400 = "global-red-400", t.ColorsLightSecondary = "colors-light-secondary", t.ColorsLightText = "colors-light-text", t.ColorsLightDarkBlue = "colors-light-dark-blue", t))(xi || {}), Ci = /* @__PURE__ */ ((t) => (t.none = "none", t.robot = "robot", t.user = "user", t.group = "group", t.deleted = "deleted", t.anonymous = "anonymous", t.undefinded = "undefinded", t))(Ci || {});
const Zs = {
  anonymous: Q`
...
let tt = class extends u {
  constructor() {
    super(...arguments), this.size = "36", this.rounded = "circle", this.status = "none", this.color = "global-blue-400", this.target = "_self", this.icon = "none", this.sliced = !1, this.hidden = !1;
  }
  _trimAvatarCharacter(t) {
    if (this.title)
      return this.title.length > 1 ? (this._croppedTitle = t.split("").shift(), this._croppedTitle) : t;
  }
  _setColorOrImage() {
...
nt([
  n({ type: String, attribute: "image-link" })
], tt.prototype, "imageLink", 2);
nt([
  n({ type: String, reflect: !0 })
], tt.prototype, "href", 2);
nt([
  n({ type: String })
], tt.prototype, "target", 2);
nt([
  n({ type: String, reflect: !0, attribute: "custom-color" })
], tt.prototype, "customColor", 2);
nt([
  n({ type: String, reflect: !0 })
], tt.prototype, "icon", 2);
nt([
  n({ type: Boolean, reflect: !0 })
], tt.prototype, "sliced", 2);
nt([
  n({ type: Boolean, reflect: !0 })
], tt.prototype, "hidden", 2);
nt([
  Y()
], tt.prototype, "_croppedTitle", 2);
tt = nt([
  f($i)
], tt);
const Xs = w`
...
`;
var Ys = Object.defineProperty, Js = Object.getOwnPropertyDescriptor, Ir = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Js(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
let Ce = class extends u {
  constructor() {
    super(...arguments), this.totalUsers = 0, this.counterSize = "24", this.counterRounded = "circle";
  }
  render() {
    return l`
...
Ce.styles = [Ks];
Ir([
  n({ type: Number, attribute: "total-users" })
], Ce.prototype, "totalUsers", 2);
Ir([
  n({ type: String, attribute: "counter-size" })
], Ce.prototype, "counterSize", 2);
Ir([
  n({ attribute: "counter-rounded" })
], Ce.prototype, "counterRounded", 2);
Ce = Ir([
  f(ki)
], Ce);
var Qs = Object.defineProperty, ta = Object.getOwnPropertyDescriptor, fe = (t, e, r, i) => {
...
let Mt = class extends u {
  constructor() {
    super(...arguments), this.displayUsers = 2, this.totalUsers = 0, this.counterSize = "24", this.counterRounded = "circle", this._counterValue = 0, this._counterHidden = !1;
  }
  get avatars() {
  ...
  _updateDisplayedUsers() {
    var e, r;
    const t = (r = (e = this.shadowRoot) == null ? void 0 : e.querySelector("slot")) == null ? void 0 : r.assignedElements();
    t && t.forEach((i, o) => {
      i.hidden = o >= this.displayUsers;
    });
  }
  _updateCounterValue() {
    this.avatarCounter ? this._counterHidden = this._counterValue === 0 : (this._counterValue = Math.max(0, this.totalUsers - this.displayUsers), this._counterHidden = this._counterValue === 0);
  }
  _applySliceEffect() {
    var e, r;
    const t = (r = (e = this.shadowRoot) == null ? void 0 : e.querySelector("slot")) == null ? void 0 : r.assignedElements();
  ...
  updated(t) {
    (t.has("displayUsers") || t.has("totalUsers")) && (this._updateDisplayedUsers(), this._updateCounterValue()), this._applySliceEffect();
  }
  render() {
    return l`
...
Mt.styles = [Xs];
fe([
  n({ type: Number, attribute: "display-users" })
], Mt.prototype, "displayUsers", 2);
fe([
  n({ type: Number, attribute: "total-users" })
...
fe([
  n({ type: String, attribute: "counter-rounded" })
], Mt.prototype, "counterRounded", 2);
fe([
  Y()
], Mt.prototype, "_counterValue", 2);
fe([
  Y()
], Mt.prototype, "_counterHidden", 2);
Mt = fe([
  f(ea)
], Mt);
const ra = w`
...
`;
var oa = Object.defineProperty, ia = Object.getOwnPropertyDescriptor, Oi = (t, e, r, i) => {
...
`;
var aa = Object.defineProperty, na = Object.getOwnPropertyDescriptor, Ei = (t, e, r, i) => {
...
let kr = class extends u {
  ...
  _checkMaxValue() {
    return !Number.isInteger(this.value) || this.value <= 0 ? "" : this.value > 99 ? "99+" : this.value.toString();
  }
  update(t) {
...
`;
var ca = Object.defineProperty, da = Object.getOwnPropertyDescriptor, pa = (t, e, r, i) => {
...
`;
var ua = Object.defineProperty, va = Object.getOwnPropertyDescriptor, ga = (t, e, r, i) => {
...
`;
var _a = Object.defineProperty, ma = Object.getOwnPropertyDescriptor, Tr = (t, e, r, i) => {
...
var ya = Object.defineProperty, xa = Object.getOwnPropertyDescriptor, or = (t, e, r, i) => {
...
let le = class extends u {
  constructor() {
    super(...arguments), this.position = "bottom-left", this.width = 250, this.selectedMode = !1, this.visible = !1;
  }
  get options() {
...
or([
  n({ type: Boolean, reflect: !0, attribute: "selected-mode" })
], le.prototype, "selectedMode", 2);
or([
  n({ type: Boolean, reflect: !0 })
], le.prototype, "visible", 2);
le = or([
  f(Pi)
], le);
var Ca = Object.defineProperty, $a = Object.getOwnPropertyDescriptor, Ai = (t, e, r, i) => {
...
let Or = class extends u {
  constructor() {
    super(...arguments), this.notClosing = !1, this._handleOutsideClick = (t) => {
  ...
  _handleDropdown(t) {
    const e = t.target;
    e.tagName !== "AWC-DROPDOWN-ITEM" && (this.options.visible = !this.options.visible, e.tagName === "AWC-DROPDOWN-GROUP" && (this.options.visible = !0));
  }
  updated(t) {
    super.updated(t), t.has("notClosing") && (this.notClosing ? document.removeEventListener("click", this._handleOutsideClick) : document.addEventListener("click", this._handleOutsideClick));
  }
  disconnectedCallback() {
...
Or.styles = [fa];
Ai([
  n({ type: Boolean, reflect: !0, attribute: "not-closing" })
], Or.prototype, "notClosing", 2);
Or = Ai([
  f("awc-dropdown")
], Or);
const ka = w`
...
`;
var Oa = Object.defineProperty, Ea = Object.getOwnPropertyDescriptor, ho = (t, e, r, i) => {
...
function kt(t) {
  ...
  class z extends t {
    ...
    constructor(...v) {
      var b, m, k;
      super(...v), e.add(this), this.internals = this.attachInternals(), r.set(this, !1), i.set(this, !1), o.set(this, !1), s.set(this, void 0), a.set(this, void 0), d.set(this, !0), c.set(this, ""), h.set(this, () => {
        N(this, o, !0, "f"), N(this, r, !0, "f"), B(this, e, "m", C).call(this);
      }), p.set(this, () => {
        N(this, r, !1, "f"), B(this, e, "m", $).call(this, this.shouldFormValueUpdate() ? B(this, c, "f") : ""), !this.validity.valid && B(this, o, "f") && N(this, i, !0, "f");
        const T = B(this, e, "m", C).call(this);
        this.validationMessageCallback && this.validationMessageCallback(T ? this.internals.validationMessage : "");
      }), g.set(this, () => {
        var T;
        B(this, d, "f") && this.validationTarget && (this.internals.setValidity(this.validity, this.validationMessage, this.validationTarget), N(this, d, !1, "f")), N(this, o, !0, "f"), N(this, i, !0, "f"), B(this, e, "m", C).call(this), (T = this === null || this === void 0 ? void 0 : this.validationMessageCallback) === null || T === void 0 || T.call(this, this.showError ? this.internals.validationMessage : "");
      }), y.set(this, void 0), _.set(this, !1), O.set(this, Promise.resolve()), (b = this.addEventListener) === null || b === void 0 || b.call(this, "focus", B(this, h, "f")), (m = this.addEventListener) === null || m === void 0 || m.call(this, "blur", B(this, p, "f")), (k = this.addEventListener) === null || k === void 0 || k.call(this, "invalid", B(this, g, "f")), this.setValue(null);
    }
     ...
     */
    static get observedAttributes() {
      const v = this.validators.map((k) => k.attribute).flat(), b = super.observedAttributes || [];
    ...
    setValue(v) {
      var b;
      N(this, i, !1, "f"), (b = this.validationMessageCallback) === null || b === void 0 || b.call(this, ""), N(this, c, v, "f");
      const k = this.shouldFormValueUpdate() ? v : null;
      this.internals.setFormValue(k), B(this, e, "m", $).call(this, k), this.valueChangedCallback && this.valueChangedCallback(k), B(this, e, "m", C).call(this);
    }
    /**
    ...
    formResetCallback() {
      var v, b;
      N(this, o, !1, "f"), N(this, i, !1, "f"), B(this, e, "m", C).call(this), (v = this.resetFormControl) === null || v === void 0 || v.call(this), (b = this.validationMessageCallback) === null || b === void 0 || b.call(this, B(this, e, "m", C).call(this) ? this.validationMessage : "");
    }
  }
  return r = /* @__PURE__ */ new WeakMap(), i = /* @__PURE__ */ new WeakMap(), o = /* @__PURE__ */ new WeakMap(), s = /* @__PURE__ */ new WeakMap(), a = /* @__PURE__ */ new WeakMap(), d = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap(), h = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), g = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), e = /* @__PURE__ */ new WeakSet(), C = function() {
    if (this.hasAttribute("disabled"))
      return !1;
    const v = B(this, i, "f") || B(this, o, "f") && !this.validity.valid && !B(this, r, "f");
    return v && this.internals.states ? this.internals.states.add("--show-error") : this.internals.states && this.internals.states.delete("--show-error"), v;
  }, $ = function(v) {
    const b = this.constructor, m = {}, k = b.validators, T = [], j = k.some((H) => H.isValid instanceof Promise);
    B(this, _, "f") || (N(this, O, new Promise((H) => {
      N(this, y, H, "f");
    }), "f"), N(this, _, !0, "f")), B(this, s, "f") && (B(this, s, "f").abort(), N(this, a, B(this, s, "f"), "f"));
    const R = new AbortController();
    N(this, s, R, "f");
    let Z, G = !1;
    k.length && (k.forEach((H) => {
      const xt = H.key || "customError", U = H.isValid(this, v, R.signal);
      U instanceof Promise ? (T.push(U), U.then((Ht) => {
        Ht != null && (m[xt] = !Ht, Z = B(this, e, "m", M).call(this, H, v), B(this, e, "m", L).call(this, m, Z));
      })) : (m[xt] = !U, this.validity[xt] !== !U && (G = !0), !U && !Z && (Z = B(this, e, "m", M).call(this, H, v)));
    }), Promise.allSettled(T).then(() => {
      var H;
      R != null && R.signal.aborted || (N(this, _, !1, "f"), (H = B(this, y, "f")) === null || H === void 0 || H.call(this));
    }), (G || !j) && B(this, e, "m", L).call(this, m, Z));
  }, L = function(v, b) {
    if (this.validationTarget)
      this.internals.setValidity(v, b, this.validationTarget), N(this, d, !1, "f");
    else {
      if (this.internals.setValidity(v, b), this.internals.validity.valid)
        return;
      N(this, d, !0, "f");
    }
  }, M = function(v, b) {
...
`;
var La = Object.defineProperty, Ba = Object.getOwnPropertyDescriptor, Le = (t, e, r, i) => {
...
let Zt = class extends kt(u) {
  constructor() {
    super(...arguments), this.value = "", this.name = "", this.label = "", this.hint = "", this.focusedOptionIndex = 0;
  }
  get options() {
  ...
  _handleKeyDown(t) {
    if (["ArrowDown", "ArrowRight"].includes(t.key))
    ...
    else if (["ArrowUp", "ArrowLeft"].includes(t.key))
      this.focusedOptionIndex--;
      ...
      return;
    this.focusedOptionIndex = Math.max(0, Math.min(this.focusedOptionIndex, this.availableOptions.length - 1)), this.availableOptions[this.focusedOptionIndex].focus(), t.preventDefault();
  }
  _handleFocus() {
  ...
  connectedCallback() {
    super.connectedCallback(), this.tabIndex = 0, this.addEventListener("focus", this._handleFocus), this.addEventListener("keydown", this._handleKeyDown), this._setupAwcRadioValues(), document.addEventListener("DOMContentLoaded", () => {
...
Le([
  P(Kr)
], Zt.prototype, "_onChange", 2);
Zt = Le([
  f("awc-radio-group")
], Zt);
var Ia = Object.defineProperty, Ta = Object.getOwnPropertyDescriptor, rt = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Ta(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
let W = class extends kt(u) {
  constructor() {
    super(...arguments), this.staticError = !1, this.disabled = !1, this.checked = !1, this.required = !1, this.validationMessage = "", this._handleFieldValueChange = (t) => {
      const e = t.detail;
  ...
  validationMessageCallback(t) {
    this.customError && !this.staticError ? (this.validationMessage = t, this.validationMessage = this.customError) : this.validationMessage = t;
  }
  shouldFormValueUpdate() {
    return this.checked;
  }
  connectedCallback() {
    super.connectedCallback(), this.addEventListener("invalid", this._onInvalid), this._setupFieldListener();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._onInvalid), this._cleanupFieldListener();
  }
  _setupFieldListener() {
    var t;
    this.field = this.closest("awc-radio-group"), this.field || console.warn("awc-radio is designed to be used inside an awc-radio-group", this), (t = this.field) == null || t.addEventListener(Kr, this._handleFieldValueChange);
  }
...
rt([
  n({ reflect: !0, attribute: "custom-error" })
], W.prototype, "customError", 2);
rt([
  n({ type: Boolean, reflect: !0, attribute: "static-error" })
], W.prototype, "staticError", 2);
rt([
  n({ type: Boolean, reflect: !0 })
...
rt([
  P("awc-checked")
], W.prototype, "_onChecked", 2);
rt([
  P("awc-focus")
], W.prototype, "_onFocus", 2);
rt([
  P("awc-blur")
], W.prototype, "_onBlur", 2);
rt([
  S("[role=radio]")
], W.prototype, "_radioElement", 2);
rt([
  S("[role=radio]")
], W.prototype, "validationTarget", 2);
rt([
  Y()
], W.prototype, "validationMessage", 2);
W = rt([
  f(Li)
], W);
const Da = globalThis.SubmitEvent = typeof globalThis.SubmitEvent < "u" ? SubmitEvent : Event, Yr = (t) => {
...
`;
var za = Object.defineProperty, Ra = Object.getOwnPropertyDescriptor, uo = (t, e, r, i) => {
...
var Fa = Object.defineProperty, Va = Object.getOwnPropertyDescriptor, ot = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Va(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const qa = (t) => t.strings === void 0, Ha = {}, Ua = (t, e = Ha) => t._$AH = e;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ir = co(class extends po {
  constructor(t) {
    if (super(t), t.type !== Nt.PROPERTY && t.type !== Nt.ATTRIBUTE && t.type !== Nt.BOOLEAN_ATTRIBUTE) throw Error("The `live` directive is not allowed on child or event bindings");
...
`;
var Wa = Object.defineProperty, Ga = Object.getOwnPropertyDescriptor, J = (t, e, r, i) => {
...
let q = class extends kt(u) {
  constructor() {
    super(...arguments), this.label = "", this.name = "", this.checked = !1, this.required = !1, this.disabled = !1, this.indeterminate = !1, this.staticError = !1, this.customError = "", this.validationMessage = "", this._handleFieldValueChange = (t) => {
  ...
  connectedCallback() {
    super.connectedCallback(), this.addEventListener("invalid", this._onInvalid), yi(() => {
      this.field = this.closest(Di), this.field && this.addEventListener(Wo, this._handleFieldValueChange);
    });
  }
  disconnectedCallback() {
    var t;
    super.disconnectedCallback(), this.removeEventListener("invalid", this._onInvalid), (t = this.field) == null || t.removeEventListener(Wo, this._handleFieldValueChange);
  }
  focus() {
  ...
  _handleChange(t) {
    const e = t.target;
    e.checkValidity(), this.checked = e.checked, this.onChange(e.checked), this.dispatchEvent(new Event("change", { bubbles: !0, composed: !0 })), this.indeterminate = !1;
  }
  render() {
    const t = {
      checkbox: !0,
...
J([
  n({ type: Boolean, reflect: !0, attribute: "static-error" })
], q.prototype, "staticError", 2);
J([
  n({ reflect: !0, attribute: "custom-error" })
], q.prototype, "customError", 2);
J([
  Y()
], q.prototype, "validationMessage", 2);
J([
  P("awc-checkbox-change")
], q.prototype, "onChange", 2);
J([
  P("awc-focus")
], q.prototype, "onFocus", 2);
J([
  P("awc-blur")
], q.prototype, "onBlur", 2);
J([
  S("input")
], q.prototype, "checkboxElement", 2);
J([
  S("label")
], q.prototype, "labelCheckboxElement", 2);
J([
  S("input[type=checkbox]")
], q.prototype, "validationTarget", 2);
q = J([
  f(Ti)
], q);
const Za = w`
...
`;
var Xa = Object.defineProperty, Ka = Object.getOwnPropertyDescriptor, sr = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Ka(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Xa(e, r, o), o;
};
const Di = "awc-checkbox-group", Wo = "awc-checkbox-group-change";
let ce = class extends kt(u) {
  constructor() {
    super(...arguments), this.value = [], this.label = "", this.hint = "", this.focusedOptionIndex = 0;
  }
  get options() {
  ...
  updated(t) {
    super.updated(t), t.has("value") && (this.setValue(this.checkedOptions.join(", ")), this._onChange(this.value));
  }
  _handleCheckboxItem() {
  ...
  handleKeyDown(t) {
    if (["ArrowDown", "ArrowRight"].includes(t.key))
      ...
      if (t.shiftKey ? this.focusedOptionIndex-- : this.focusedOptionIndex++, this.focusedOptionIndex === this.availableOptions.length) {
    ...
    ), this.availableOptions[this.focusedOptionIndex].focus(), t.preventDefault();
  }
  handleFocus() {
    this.availableOptions[this.focusedOptionIndex].focus();
  }
...
sr([
  P("awc-checkbox-group-change")
], ce.prototype, "_onChange", 2);
ce = sr([
  f(Di)
], ce);
const Ya = w`
...
`;
var Ja = Object.defineProperty, Qa = Object.getOwnPropertyDescriptor, we = (t, e, r, i) => {
...
let jt = class extends kt(u) {
  ...
  _handleToggle() {
    this.disabled || (this.checked = !this.checked, this._onToggle(this.checked), this._onChange());
  }
  _handleKeyDown(t) {
...
we([
  P("awc-switcher-toggle")
], jt.prototype, "_onToggle", 2);
jt = we([
  f("awc-switcher")
], jt);
const tn = w`
...
`;
var en = Object.defineProperty, rn = Object.getOwnPropertyDescriptor, vo = (t, e, r, i) => {
...
`;
var sn = Object.defineProperty, an = Object.getOwnPropertyDescriptor, D = (t, e, r, i) => {
...
let A = class extends kt(u) {
  constructor() {
    super(...arguments), this.value = "", this.placeholder = "Placeholder", this.type = "text", this.size = "medium", this.customError = "", this.autocomplete = "off", this.autofocus = !1, this.required = !1, this.disabled = !1, this.readonly = !1, this.staticError = !1, this.validationMessage = "", this.inputId = Math.random().toString(36).substring(2);
  }
  validityCallback() {
    var t;
    return (t = this.validationTarget) == null ? void 0 : t.validationMessage;
  ...
  _updateCharacterLimit() {
    if (this.input && this._progressBar && this.maxlength !== void 0) {
      const t = this.maxlength, e = this.value.length, r = e / t * 360;
      if (e * 100 / t > 70 ? this._progressBar.classList.add("awc-input__progress--percent") : this._progressBar.classList.remove("awc-input__progress--percent"), this._progressBar.style.setProperty("--progress", `${r}deg`), t < e) {
        const o = t - e;
        this._progressBar.setAttribute("length", `${o}`), this._progressBar.classList.add("awc-input__progress--length-warning"), o < -99 ? this._progressBar.classList.add("awc-input__progress--small-font") : this._progressBar.classList.remove("awc-input__progress--small-font");
      } else
        this._progressBar.removeAttribute("length"), this._progressBar.classList.remove("awc-input__progress--length-warning");
    }
  }
  _paddingInputIcon() {
    (this.input && this._passwordButton || this.input && this._progressBar) && this.input.classList.add("has-padding-icon");
  }
  _onKeyDown(t) {
    if (t.code === "Enter" && this.form) {
      t.preventDefault();
      const e = this.form.querySelector("button[type='submit']"), r = this.form.querySelector("awc-button[type='submit']");
      e ? setTimeout(() => e.click()) : r ? (setTimeout(() => r.click()), Yr(this.form)) : Yr(this.form);
    }
  }
  _onInput(t) {
    this.value = t.target.value, this.dispatchEvent(new InputEvent("input", { composed: !0, bubbles: !0 }));
  }
  _onChange(t) {
    this.value = t.target.value, this.dispatchEvent(new Event("change", { composed: !0, bubbles: !0 }));
  }
  _onInvalid(t) {
  ...
  updated(t) {
    super.updated(t), t.has("value") && this.setValue(this.value), t.has("value") && this.maxlength && this._updateCharacterLimit(), (this.type === "password" || this.maxlength) && this._paddingInputIcon();
  }
  render() {
    const t = {
      "awc-input": !0,
    ...
    }, e = this.type === "password" ? this._renderPasswordButton() : "", r = this.maxlength && !e ? l`<div class="awc-input__progress"></div>` : "";
    return l`
...
D([
  S(".awc-input__password")
], A.prototype, "_passwordButton", 2);
D([
  S(".awc-input__progress")
], A.prototype, "_progressBar", 2);
A = D([
  f(nn)
], A);
const ln = w`
...
`;
var cn = Object.defineProperty, dn = Object.getOwnPropertyDescriptor, lt = (t, e, r, i) => {
...
let K = class extends kt(u) {
  constructor() {
    super(...arguments), this.value = "", this.autofocus = !1, this.readonly = !1, this.disabled = !1, this.resize = !1, this.autoheight = !1, this.autocomplete = "off", this.rows = 2, this.cols = 20, this.textAreaId = Math.random().toString(36).substring(2);
  }
  _handleInput() {
    this._autoHeightTextArea(this.textarea), this.value = this.textarea.value, this._onInput.bind(this);
  }
  resetFormControl() {
    this.value = "";
  }
  _autoHeightTextArea(t) {
    this.autoheight && !this.resize && (t.style.height = "auto", t.style.height = `${t.scrollHeight}px`);
  }
  _onInput(t) {
    this.value = t.target.value, this.dispatchEvent(
      new InputEvent("input", { composed: !0, bubbles: !0 })
    );
  }
  _onChange(t) {
    this.value = t.target.value, this.dispatchEvent(new Event("change", { composed: !0, bubbles: !0 }));
  ...
  updated(t) {
    super.updated(t), t.has("value") && (this.setValue(this.value), this.textarea.value = this.value);
  }
  firstUpdated() {
...
`;
var un = Object.defineProperty, vn = Object.getOwnPropertyDescriptor, Mr = (t, e, r, i) => {
...
let ke = class extends u {
  ...
  _stepUpdater() {
    ...
    if (t <= this.report.length) {
      e.forEach((i, o) => {
        const s = o + 1, a = s < t, d = s === t;
        i.classList.toggle("progress-item--past", a), i.classList.toggle("progress-item--current", d), a && i.classList.remove("progress-item--completed");
      });
...
`;
var fn = Object.defineProperty, wn = Object.getOwnPropertyDescriptor, jr = (t, e, r, i) => {
...
let Ze = class extends u {
  ...
  _setGlobalIcons() {
    const t = this.type, e = this.size, r = this.src, i = window.__AWC_ICONS || {};
...
var bn = Object.defineProperty, _n = Object.getOwnPropertyDescriptor, ar = (t, e, r, i) => {
...
let de = class extends u {
  ...
  _getGlobalIcon() {
    ...
    if (t && t[this.type] && t[this.type][this.size])
      return t[this.type][this.size];
  }
  render() {
...
ar([
  n({ type: String, attribute: "icon-scale" })
], de.prototype, "iconScale", 2);
de = ar([
  f(Mi)
], de);
var it = "top", ut = "bottom", vt = "right", st = "left", go = "auto", nr = [it, ut, vt, st], Oe = "start", Xe = "end", mn = "clippingParents", ji = "viewport", Me = "popper", yn = "reference", Go = /* @__PURE__ */ nr.reduce(function(t, e) {
  return t.concat([e + "-" + Oe, e + "-" + Xe]);
}, []), zi = /* @__PURE__ */ [].concat(nr, [go]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Oe, e + "-" + Xe]);
}, []), xn = "beforeRead", Cn = "read", $n = "afterRead", kn = "beforeMain", On = "main", En = "afterMain", Sn = "beforeWrite", Pn = "write", An = "afterWrite", Ln = [xn, Cn, $n, kn, On, En, Sn, Pn, An];
function Et(t) {
...
function Bn(t) {
  ...
  Object.keys(e.elements).forEach(function(r) {
    var i = e.styles[r] || {}, o = e.attributes[r] || {}, s = e.elements[r];
    !ht(s) || !Et(s) || (Object.assign(s.style, i), Object.keys(o).forEach(function(a) {
      var d = o[a];
...
function In(t) {
  ...
  return Object.assign(e.elements.popper.style, r.popper), e.styles = r, e.elements.arrow && Object.assign(e.elements.arrow.style, r.arrow), function() {
    Object.keys(e.elements).forEach(function(i) {
      var o = e.elements[i], s = e.attributes[i] || {}, a = Object.keys(e.styles.hasOwnProperty(i) ? e.styles[i] : r[i]), d = a.reduce(function(c, h) {
        return c[h] = "", c;
      }, {});
      !ht(o) || !Et(o) || (Object.assign(o.style, d), Object.keys(s).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
var se = Math.max, Er = Math.min, Ee = Math.round;
function Jr() {
...
function Se(t, e, r) {
  ...
  e && ht(t) && (o = t.offsetWidth > 0 && Ee(i.width) / t.offsetWidth || 1, s = t.offsetHeight > 0 && Ee(i.height) / t.offsetHeight || 1);
  var a = pe(t) ? ct(t) : window, d = a.visualViewport, c = !Ri() && r, h = (i.left + (c && d ? d.offsetLeft : 0)) / o, p = (i.top + (c && d ? d.offsetTop : 0)) / s, g = i.width / o, y = i.height / s;
  return {
    width: g,
    height: y,
    top: p,
...
function wo(t) {
  var e = Se(t), r = t.offsetWidth, i = t.offsetHeight;
...
function Zo(t) {
  ...
  zt(t).position === "fixed" ? null : t.offsetParent;
}
function Mn(t) {
  var e = /firefox/i.test(Jr()), r = /Trident/i.test(Jr());
  if (r && ht(t)) {
    var i = zt(t);
    if (i.position === "fixed")
      return null;
...
function lr(t) {
  for (var e = ct(t), r = Zo(t); r && Dn(r) && zt(r).position === "static"; )
    r = Zo(r);
  return r && (Et(r) === "html" || Et(r) === "body" && zt(r).position === "static") ? e : r || Mn(t) || e;
}
function bo(t) {
...
var zn = function(e, r) {
  ...
  })) : e, qi(typeof e != "number" ? e : Hi(e, nr));
};
function Rn(t) {
  var e, r = t.state, i = t.name, o = t.options, s = r.elements.arrow, a = r.modifiersData.popperOffsets, d = Ot(r.placement), c = bo(d), h = [st, vt].indexOf(d) >= 0, p = h ? "height" : "width";
  if (!(!s || !a)) {
    var g = zn(o.padding, r), y = wo(s), _ = c === "y" ? it : st, O = c === "y" ? ut : vt, C = r.rects.reference[p] + r.rects.reference[c] - a[c] - r.rects.popper[p], $ = a[c] - r.rects.reference[c], L = lr(s), M = L ? c === "y" ? L.clientHeight || 0 : L.clientWidth || 0 : 0, z = C / 2 - $ / 2, x = g[_], v = M - y[p] - g[O], b = M / 2 - y[p] / 2 + z, m = Re(x, b, v), k = c;
    r.modifiersData[i] = (e = {}, e[k] = m, e.centerOffset = m - b, e);
  }
}
function Fn(t) {
  var e = t.state, r = t.options, i = r.element, o = i === void 0 ? "[data-popper-arrow]" : i;
  o != null && (typeof o == "string" && (o = e.elements.popper.querySelector(o), !o) || Fi(e.elements.popper, o) && (e.elements.arrow = o));
}
const Vn = {
  name: "arrow",
  enabled: !0,
...
function Hn(t, e) {
  var r = t.x, i = t.y, o = e.devicePixelRatio || 1;
  return {
    x: Ee(r * o) / o || 0,
    y: Ee(i * o) / o || 0
  };
...
function Xo(t) {
  var e, r = t.popper, i = t.popperRect, o = t.placement, s = t.variation, a = t.offsets, d = t.position, c = t.gpuAcceleration, h = t.adaptive, p = t.roundOffsets, g = t.isFixed, y = a.x, _ = y === void 0 ? 0 : y, O = a.y, C = O === void 0 ? 0 : O, $ = typeof p == "function" ? p({
    x: _,
    y: C
  }) : {
    x: _,
  ...
  _ = $.x, C = $.y;
  var L = a.hasOwnProperty("x"), M = a.hasOwnProperty("y"), z = st, x = it, v = window;
  if (h) {
    var b = lr(r), m = "clientHeight", k = "clientWidth";
    if (b === ct(r) && (b = Kt(r), zt(b).position !== "static" && d === "absolute" && (m = "scrollHeight", k = "scrollWidth")), b = b, o === it || (o === st || o === vt) && s === Xe) {
      x = ut;
      var T = g && b === v && v.visualViewport ? v.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        b[m]
      );
    ...
    if (o === st || (o === it || o === ut) && s === Xe) {
      z = vt;
      var j = g && b === v && v.visualViewport ? v.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        b[k]
      );
      _ -= j - i.width, _ *= c ? 1 : -1;
  ...
  if (_ = Z.x, C = Z.y, c) {
    var G;
    return Object.assign({}, R, (G = {}, G[x] = M ? "0" : "", G[z] = L ? "0" : "", G.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + _ + "px, " + C + "px)" : "translate3d(" + _ + "px, " + C + "px, 0)", G));
  }
  return Object.assign({}, R, (e = {}, e[x] = M ? C + "px" : "", e[z] = L ? _ + "px" : "", e.transform = "", e));
}
function Un(t) {
  var e = t.state, r = t.options, i = r.gpuAcceleration, o = i === void 0 ? !0 : i, s = r.adaptive, a = s === void 0 ? !0 : s, d = r.roundOffsets, c = d === void 0 ? !0 : d, h = {
  ...
  e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, Xo(Object.assign({}, h, {
    offsets: e.modifiersData.popperOffsets,
    position: e.options.strategy,
    adaptive: a,
    roundOffsets: c
  })))), e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, Xo(Object.assign({}, h, {
...
function Wn(t) {
  var e = t.state, r = t.instance, i = t.options, o = i.scroll, s = o === void 0 ? !0 : o, a = i.resize, d = a === void 0 ? !0 : a, c = ct(e.elements.popper), h = [].concat(e.scrollParents.reference, e.scrollParents.popper);
  return s && h.forEach(function(p) {
    p.addEventListener("scroll", r.update, wr);
  }), d && c.addEventListener("resize", r.update, wr), function() {
    s && h.forEach(function(p) {
...
function _o(t) {
  var e = ct(t), r = e.pageXOffset, i = e.pageYOffset;
  return {
    scrollLeft: r,
    scrollTop: i
  };
...
function Kn(t, e) {
  var r = ct(t), i = Kt(t), o = r.visualViewport, s = i.clientWidth, a = i.clientHeight, d = 0, c = 0;
  if (o) {
...
function Yn(t) {
  var e, r = Kt(t), i = _o(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, s = se(r.scrollWidth, r.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), a = se(r.scrollHeight, r.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), d = -i.scrollLeft + mo(t), c = -i.scrollTop;
  return zt(o || r).direction === "rtl" && (d += se(r.clientWidth, o ? o.clientWidth : 0) - s), {
    width: s,
    height: a,
    x: d,
    y: c
...
function yo(t) {
  var e = zt(t), r = e.overflow, i = e.overflowX, o = e.overflowY;
  return /auto|scroll|overlay|hidden/.test(r + o + i);
}
function Ui(t) {
  return ["html", "body", "#document"].indexOf(Et(t)) >= 0 ? t.ownerDocument.body : ht(t) && yo(t) ? t : Ui(zr(t));
}
function Fe(t, e) {
  var r;
  e === void 0 && (e = []);
  var i = Ui(t), o = i === ((r = t.ownerDocument) == null ? void 0 : r.body), s = ct(i), a = o ? [s].concat(s.visualViewport || [], yo(i) ? i : []) : i, d = e.concat(a);
  return o ? d : (
...
function Qn(t) {
  var e = Fe(zr(t)), r = ["absolute", "fixed"].indexOf(zt(t).position) >= 0, i = r && ht(t) ? lr(t) : t;
  return pe(i) ? e.filter(function(o) {
    return pe(o) && Fi(o, i) && Et(o) !== "body";
  }) : [];
}
function tl(t, e, r, i) {
  var o = e === "clippingParents" ? Qn(t) : [].concat(e), s = [].concat(o, [r]), a = s[0], d = s.reduce(function(c, h) {
    var p = Yo(t, h, i);
    return c.top = se(p.top, c.top), c.right = Er(p.right, c.right), c.bottom = Er(p.bottom, c.bottom), c.left = se(p.left, c.left), c;
  }, Yo(t, a, i));
  return d.width = d.right - d.left, d.height = d.bottom - d.top, d.x = d.left, d.y = d.top, d;
}
function Ni(t) {
  var e = t.reference, r = t.element, i = t.placement, o = i ? Ot(i) : null, s = i ? Pe(i) : null, a = e.x + e.width / 2 - r.width / 2, d = e.y + e.height / 2 - r.height / 2, c;
  switch (o) {
    case it:
      c = {
        x: a,
...
function Ke(t, e) {
  e === void 0 && (e = {});
  var r = e, i = r.placement, o = i === void 0 ? t.placement : i, s = r.strategy, a = s === void 0 ? t.strategy : s, d = r.boundary, c = d === void 0 ? mn : d, h = r.rootBoundary, p = h === void 0 ? ji : h, g = r.elementContext, y = g === void 0 ? Me : g, _ = r.altBoundary, O = _ === void 0 ? !1 : _, C = r.padding, $ = C === void 0 ? 0 : C, L = qi(typeof $ != "number" ? $ : Hi($, nr)), M = y === Me ? yn : Me, z = t.rects.popper, x = t.elements[O ? M : y], v = tl(pe(x) ? x : x.contextElement || Kt(t.elements.popper), c, p, a), b = Se(t.elements.reference), m = Ni({
    reference: b,
    element: z,
    strategy: "absolute",
    placement: o
  }), k = Qr(Object.assign({}, z, m)), T = y === Me ? k : b, j = {
  ...
  if (y === Me && R) {
    ...
    Object.keys(j).forEach(function(G) {
      var H = [vt, ut].indexOf(G) >= 0 ? 1 : -1, xt = [it, ut].indexOf(G) >= 0 ? "y" : "x";
      j[G] += Z[xt] * H;
    });
  }
  return j;
...
function el(t, e) {
  e === void 0 && (e = {});
  var r = e, i = r.placement, o = r.boundary, s = r.rootBoundary, a = r.padding, d = r.flipVariations, c = r.allowedAutoPlacements, h = c === void 0 ? zi : c, p = Pe(i), g = p ? d ? Go : Go.filter(function(O) {
    return Pe(O) === p;
  }) : nr, y = g.filter(function(O) {
...
function ol(t) {
  ...
  if (!e.modifiersData[i]._skip) {
    for (var o = r.mainAxis, s = o === void 0 ? !0 : o, a = r.altAxis, d = a === void 0 ? !0 : a, c = r.fallbackPlacements, h = r.padding, p = r.boundary, g = r.rootBoundary, y = r.altBoundary, _ = r.flipVariations, O = _ === void 0 ? !0 : _, C = r.allowedAutoPlacements, $ = e.options.placement, L = Ot($), M = L === $, z = c || (M || !O ? [_r($)] : rl($)), x = [$].concat(z).reduce(function(_e, Ut) {
      return _e.concat(Ot(Ut) === go ? el(e, {
        placement: Ut,
        boundary: p,
        rootBoundary: g,
        padding: h,
    ...
    }, []), v = e.rects.reference, b = e.rects.popper, m = /* @__PURE__ */ new Map(), k = !0, T = x[0], j = 0; j < x.length; j++) {
      var R = x[j], Z = Ot(R), G = Pe(R) === Oe, H = [it, ut].indexOf(Z) >= 0, xt = H ? "width" : "height", U = Ke(e, {
        placement: R,
        boundary: p,
        rootBoundary: g,
        altBoundary: y,
      ...
      v[xt] > b[xt] && (dt = _r(dt));
      var Ht = _r(dt), te = [];
      if (s && te.push(U[Z] <= 0), d && te.push(U[dt] <= 0, U[Ht] <= 0), te.every(function(_e) {
        return _e;
      })) {
        T = R, k = !1;
        break;
    ...
    if (k)
      for (var ur = O ? 3 : 1, Fr = function(Ut) {
...
function sl(t) {
  var e = t.state, r = t.name, i = e.rects.reference, o = e.rects.popper, s = e.modifiersData.preventOverflow, a = Ke(e, {
    elementContext: "reference"
  }), d = Ke(e, {
    altBoundary: !0
  }), c = Jo(a, i), h = Jo(d, o, s), p = Qo(c), g = Qo(h);
  e.modifiersData[r] = {
...
function nl(t, e, r) {
  var i = Ot(t), o = [st, it].indexOf(i) >= 0 ? -1 : 1, s = typeof r == "function" ? r(Object.assign({}, e, {
    placement: t
  })) : r, a = s[0], d = s[1];
  return a = a || 0, d = (d || 0) * o, [st, vt].indexOf(i) >= 0 ? {
    x: d,
    y: a
  } : {
    x: a,
...
function ll(t) {
  var e = t.state, r = t.options, i = t.name, o = r.offset, s = o === void 0 ? [0, 0] : o, a = zi.reduce(function(p, g) {
    return p[g] = nl(g, e.rects, s), p;
  }, {}), d = a[e.placement], c = d.x, h = d.y;
  e.modifiersData.popperOffsets != null && (e.modifiersData.popperOffsets.x += c, e.modifiersData.popperOffsets.y += h), e.modifiersData[i] = a;
}
const cl = {
  name: "offset",
  enabled: !0,
...
function ul(t) {
  var e = t.state, r = t.options, i = t.name, o = r.mainAxis, s = o === void 0 ? !0 : o, a = r.altAxis, d = a === void 0 ? !1 : a, c = r.boundary, h = r.rootBoundary, p = r.altBoundary, g = r.padding, y = r.tether, _ = y === void 0 ? !0 : y, O = r.tetherOffset, C = O === void 0 ? 0 : O, $ = Ke(e, {
    boundary: c,
    rootBoundary: h,
    padding: g,
    altBoundary: p
  }), L = Ot(e.placement), M = Pe(e.placement), z = !M, x = bo(L), v = hl(x), b = e.modifiersData.popperOffsets, m = e.rects.reference, k = e.rects.popper, T = typeof C == "function" ? C(Object.assign({}, e.rects, {
    placement: e.placement
  })) : C, j = typeof T == "number" ? {
    mainAxis: T,
    altAxis: T
    ...
    mainAxis: 0,
    altAxis: 0
  }, T), R = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, Z = {
    x: 0,
    y: 0
  };
  if (b) {
    if (s) {
      var G, H = x === "y" ? it : st, xt = x === "y" ? ut : vt, U = x === "y" ? "height" : "width", dt = b[x], Ht = dt + $[H], te = dt - $[xt], ur = _ ? -k[U] / 2 : 0, Fr = M === Oe ? m[U] : k[U], Ie = M === Oe ? -k[U] : -m[U], vr = e.elements.arrow, _e = _ && vr ? wo(vr) : {
        width: 0,
        height: 0
      }, Ut = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Vi(), Te = Ut[H], gr = Ut[xt], ee = Re(0, m[U], _e[U]), Vr = z ? m[U] / 2 - ur - ee - Te - j.mainAxis : Fr - ee - Te - j.mainAxis, es = z ? -m[U] / 2 + ur + ee + gr + j.mainAxis : Ie + ee + gr + j.mainAxis, qr = e.elements.arrow && lr(e.elements.arrow), rs = qr ? x === "y" ? qr.clientTop || 0 : qr.clientLeft || 0 : 0, Eo = (G = R == null ? void 0 : R[x]) != null ? G : 0, os = dt + Vr - Eo - rs, is = dt + es - Eo, So = Re(_ ? Er(Ht, os) : Ht, dt, _ ? se(te, is) : te);
      b[x] = So, Z[x] = So - dt;
    }
    if (d) {
      var Po, ss = x === "x" ? it : st, as = x === "x" ? ut : vt, re = b[v], fr = v === "y" ? "height" : "width", Ao = re + $[ss], Lo = re - $[as], Hr = [it, st].indexOf(L) !== -1, Bo = (Po = R == null ? void 0 : R[v]) != null ? Po : 0, Io = Hr ? Ao : re - m[fr] - k[fr] - Bo + j.altAxis, To = Hr ? re + m[fr] + k[fr] - Bo - j.altAxis : Lo, Do = _ && Hr ? jn(Io, re, To) : Re(_ ? Io : Ao, re, _ ? To : Lo);
      b[v] = Do, Z[v] = Do - re;
    }
    e.modifiersData[i] = Z;
  }
...
function wl(t) {
  var e = t.getBoundingClientRect(), r = Ee(e.width) / t.offsetWidth || 1, i = Ee(e.height) / t.offsetHeight || 1;
  return r !== 1 || i !== 1;
}
function bl(t, e, r) {
  r === void 0 && (r = !1);
  var i = ht(e), o = ht(e) && wl(e), s = Kt(e), a = Se(t, o, r), d = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  return (i || !i && !r) && ((Et(e) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
  yo(s)) && (d = fl(e)), ht(e) ? (c = Se(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : s && (c.x = mo(s))), {
...
function Cl(t) {
  t === void 0 && (t = {});
  var e = t, r = e.defaultModifiers, i = r === void 0 ? [] : r, o = e.defaultOptions, s = o === void 0 ? ti : o;
  return function(d, c, h) {
    ...
    var p = {
      ...
      setOptions: function(L) {
        ...
        C(), p.options = Object.assign({}, s, p.options, M), p.scrollParents = {
          reference: pe(d) ? Fe(d) : d.contextElement ? Fe(d.contextElement) : [],
          popper: Fe(c)
        };
        var z = ml(xl([].concat(i, p.options.modifiers)));
        return p.orderedModifiers = z.filter(function(x) {
          return x.enabled;
        }), O(), _.update();
      },
      ...
      forceUpdate: function() {
        if (!y) {
          var L = p.elements, M = L.reference, z = L.popper;
          if (ei(M, z)) {
            p.rects = {
            ...
            for (var x = 0; x < p.orderedModifiers.length; x++) {
              ...
              var v = p.orderedModifiers[x], b = v.fn, m = v.options, k = m === void 0 ? {} : m, T = v.name;
    ...
    function O() {
      p.orderedModifiers.forEach(function($) {
        var L = $.name, M = $.options, z = M === void 0 ? {} : M, x = $.effect;
...
var $l = [Gn, pl, Nn, Tn, cl, il, vl, Vn, al], xo = /* @__PURE__ */ Cl({
  defaultModifiers: $l
});
const kl = w`
  :host {
...
`;
var Ol = Object.defineProperty, El = Object.getOwnPropertyDescriptor, Lt = (t, e, r, i) => {
...
let gt = class extends u {
  constructor() {
    super(...arguments), this.marker = !0, this.message = "Tooltip", this.position = "top", this.spacing = "S", this.strategy = "absolute", this.active = !1, this.disabled = !1, this.popperInstance = null, this.tooltipTimeout = null;
  }
  createPopperInstance() {
    !this._nestedElement || !this.shadowRoot || (this.popperInstance = xo(this._nestedElement, this._tooltip, {
  ...
  updated(t) {
    super.updated(t), (t.has("active") || t.has("position") || t.has("marker")) && (this.active ? this.createPopperInstance() : this.destroyPopperInstance()), t.has("disabled") && this.disabled ? (this.removeEventListener("focusin", this.onFocusIn), this.removeEventListener("focusout", this.onFocusOut)) : (this.addEventListener("focusin", this.onFocusIn), this.addEventListener("focusout", this.onFocusOut));
  }
  _setupTimout() {
...
Lt([
  n({ type: Boolean, reflect: !0 })
], gt.prototype, "marker", 2);
Lt([
  n({ type: String, reflect: !0 })
], gt.prototype, "message", 2);
Lt([
  n({ reflect: !0 })
], gt.prototype, "position", 2);
Lt([
  n({ type: String, reflect: !0 })
], gt.prototype, "spacing", 2);
Lt([
  n({ type: String, reflect: !0 })
], gt.prototype, "strategy", 2);
Lt([
  n({ type: Boolean, reflect: !0 })
...
Lt([
  S(".awc-tooltip")
], gt.prototype, "_tooltip", 2);
Lt([
  S(".awc-tooltip__nested")
], gt.prototype, "_nestedElement", 2);
gt = Lt([
  f("awc-tooltip")
], gt);
/**
...
let to = class extends po {
  constructor(e) {
    if (super(e), this.it = V, e.type !== Nt.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(e) {
...
`;
var Al = Object.defineProperty, Ll = Object.getOwnPropertyDescriptor, Ft = (t, e, r, i) => {
...
let ft = class extends kt(u) {
  ...
  _handleEvent() {
    this._onSelect([{ value: this.value, selected: this.selected }]), this.dispatchEvent(new Event("change", { composed: !0, bubbles: !0 }));
  }
  handleKeydown(t) {
...
Ft([
  n({ type: Boolean, reflect: !0, attribute: "no-padding" })
], ft.prototype, "noPadding", 2);
Ft([
  P("awc-select-option")
], ft.prototype, "_onSelect", 2);
Ft([
  P("awc-select-option-focus")
], ft.prototype, "onFocus", 2);
Ft([
  P("awc-select-option-blur")
], ft.prototype, "onBlur", 2);
Ft([
  S(".awc-item-focus")
], ft.prototype, "focusTarget", 2);
ft = Ft([
  f(eo)
], ft);
const Bl = w`
...
`;
var Il = Object.defineProperty, Tl = Object.getOwnPropertyDescriptor, Vt = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Tl(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Il(e, r, o), o;
};
const Wi = "awc-select-button", Dl = "awc-select-button-create";
let Ct = class extends u {
  constructor() {
    super(...arguments), this.slot = "awc-button", this.icon = !1, this.staticButton = !1, this.dynamicButton = !1, this.isClick = !1;
  }
  _handleClick() {
    if (this.isClick = !0, this._onClick(this.isClick), this.isClick && this.textContent || this.label)
      return this.textContent = "";
  }
  _handleKeyboard(t) {
    if (t.code === "Enter" && (this._handleClick(), this.isClick && t.code && this.textContent || this.label))
      return this.textContent = "";
  }
  _handleLabelOrTextContent() {
    if (this.textContent && this.label && !this.icon)
      return l`${this.label} «${this.textContent}»`;
    if (this.textContent && this.label)
      return l`${this.textContent}`;
    if (this.label)
      return l`${this.label}`;
  }
  render() {
...
Vt([
  n({ type: Boolean, reflect: !0, attribute: "static-button" })
], Ct.prototype, "staticButton", 2);
Vt([
  n({ type: Boolean, reflect: !0, attribute: "dynamic-button" })
], Ct.prototype, "dynamicButton", 2);
Vt([
  n({ type: String })
], Ct.prototype, "copyLabel", 2);
Vt([
  n()
], Ct.prototype, "textContent", 2);
Vt([
  P(Dl)
], Ct.prototype, "_onClick", 2);
Ct = Vt([
  f(Wi)
], Ct);
const Ml = w`
...
`;
var jl = Object.defineProperty, zl = Object.getOwnPropertyDescriptor, Gi = (t, e, r, i) => {
...
`;
var Fl = Object.defineProperty, Vl = Object.getOwnPropertyDescriptor, I = (t, e, r, i) => {
...
let E = class extends kt(u) {
  constructor() {
    super(...arguments), this.value = "", this.inputPlacholder = "", this.html = !1, this.disabled = !1, this.required = !1, this.autoselectOff = !1, this.reset = !1, this.multiple = !1, this.search = !1, this.customError = "", this.staticError = !1, this.validationMessage = "", this.filteredOptions = [], this.isOptionListReverse = !1, this.popperInstance = null, this._onInvalid = (t) => {
      t.preventDefault(), this.validationTarget.focus();
  ...
  _toggleOptionsList() {
    this.selectedOptions.length && this.multiple ? this._open() : this.open ? this._close() : this._open();
  }
  _open() {
    this.open = !0, this._updateHeadContent(), this._createPopperInstance(), requestAnimationFrame(() => {
      this.search && this.open && this.inputElement.focus();
    });
  }
  _close() {
    this.open = !1, this.focusedOptionIndex = -1, this._unhiddingOptions(), this._destroyPopperInstance(), this._clearInputValue();
  }
  _unhiddingOptions() {
    this.options.forEach((t) => t.removeAttribute("hidden")), this.optionGroups.forEach((t) => t.removeAttribute("hidden"));
  }
  ...
  _updateHeadContent() {
    this.selectedOptions.forEach((t) => {
      this.html && t.outerHTML ? (t.setAttribute("no-padding", "true"), this.headContent = this._getItemHTMLContent(t)) : this.headContent = this._getItemTextContent(t) || this._getItemValueAttribute(t), this.value = this._getItemValueAttribute(t) || this._getItemTextContent(t), t.removeAttribute("no-padding");
    }), this.value && this._updateFormData();
  }
  // Одиночный выбор
  _singleSelection(t) {
    t && (this.options.forEach((e) => e.selected = !1), t.selected = !0, this._updateHeadContent(), this._updateChangeEvent());
  }
  // Множественный выбор
  _multipleSelection(t) {
    this._unhiddingOptions(), this.searchText && this._clearInputValue(), t && (t.selected = !0, this._updateHeadContent(), this._updateChangeEvent());
  }
  // Событие выбора элемента
  _handleOption(t) {
    const e = t.target;
    e && (this._unhiddingOptions(), this.multiple ? this._multipleSelection(e) : this._singleSelection(e));
  }
  // Обновление CustomEvent
  _updateChangeEvent() {
    const t = this.selectedOptions.map(
      (e) => {
        var r, i;
        return {
  ...
  _removeChipsItem(t) {
    ...
    e && (e.selected = !1, this.selectedOptions.splice(t, 1), this._updateHeadContent(), this._updateChangeEvent()), this.selectedOptions.length || this.resetFormControl();
  }
  // Обновление FormData
  _updateFormData() {
  ...
  _setSelectedElement() {
    this.selectedOptions.length >= 1 && !this.multiple && (this.selectedOptions.forEach((t, e) => {
  ...
  _setAutoSelectedFirstElement() {
    this.selectedOptions.length === 0 && !this.multiple && this.options.length > 0 && (this.options[0].selected = !0, this._updateHeadContent());
  }
  // Сброс селекта
  resetFormControl() {
    this.options.forEach((t) => t.selected = !1), this.value = "", this.headContent = "", this._onChangeSelect([]), this._close();
  }
  ...
  _handleOptionKeyboard(t) {
    if (t.code === "Enter" || t.code === "Space")
      ...
      if (this.isOptionListReverse ? (t.code === "ArrowUp" && this.focusedOptionIndex--, t.code === "ArrowDown" && this.focusedOptionIndex++) : (t.code === "ArrowDown" && this.focusedOptionIndex++, t.code === "ArrowUp" && this.focusedOptionIndex--), this.search && this.searchText) {
        ...
        const e = this.options.filter(
          (r) => r.tagName === "AWC-SELECT-ITEM"
        );
        this.focusedOptionIndex = Math.max(
          0,
          Math.min(this.focusedOptionIndex, e.length - 1)
  ...
  _handleInput() {
    this.searchText = this.inputElement.value, this._filterOptions(), this._buttonSearchTextUpdate(), this._onSearch(this.searchText);
  }
  ...
  _buttonSearchTextUpdate() {
    if (this.selectButtons)
      return this.selectButtons.textContent = this.searchText;
  }
  _staticCreateButton() {
  ...
  _dynamicCreateOption() {
    if (this.selectButtons.isClick) {
      const e = this._buttonSearchTextUpdate();
      this.createSelectItem(e, e, !0), this._onCreateOption({ value: e, selected: !0, text: e }), this._clearInputValue();
    }
  }
  createSelectItem(t, e, r) {
    ...
    this.html ? i.innerHTML = t : i.textContent = t, i.value = e ?? t, r && (i.selected = !0, this.multiple || this.selectedOptions.forEach((o) => o.selected = !1)), this.appendChild(i), this.requestUpdate(), this._updateHeadContent(), this._unhiddingOptions(), this._updateFormData();
  }
  handleCreateOption(t) {
    if (this.inputElement) {
      if (t.target && this.inputElement.value === "")
        return;
      {
        const e = this.selectButtons.staticButton, r = this.selectButtons.dynamicButton;
  ...
  _filterOptions() {
    ...
    this.filteredOptions = this.options.filter((e) => {
      var o;
      const r = (o = e.textContent) == null ? void 0 : o.toLowerCase(), i = r == null ? void 0 : r.includes(t);
      return i ? e.removeAttribute("hidden") : e.setAttribute("hidden", ""), i;
    }), this._filterGroups(), this.scrollToFocusedOption();
  }
  _filterGroups() {
    this.optionGroups.forEach((t) => {
      Array.from(t.children).some(
        (r) => !r.hasAttribute("hidden")
      ) ? t.removeAttribute("hidden") : t.setAttribute("hidden", "");
    });
  }
  _showPlaceholderOrSelectItem() {
    return this.multiple && this.placeholder ? this.selectedOptions.length ? this._renderChips() : l`<p class="awc-select__placeholder">${this.placeholder}</p>` : this.multiple && !this.placeholder ? this._renderChips() : this.headContent ? this.headContent : l`<p class="awc-select__placeholder">${this.placeholder}</p>`;
  }
  _renderInput() {
    return l`
  ...
  _checkingListPosition() {
    this._selectOptions && requestAnimationFrame(() => {
      this._selectOptions.getAttribute(
        "data-popper-placement"
      ) === "top" ? this.isOptionListReverse = !0 : this.isOptionListReverse = !1;
    });
  }
  _createPopperInstance() {
    this._selectHead && this._selectOptions && (this.popperInstance = xo(
      this._selectHead,
      this._selectOptions,
      {
        placement: "bottom",
  ...
  connectedCallback() {
    super.connectedCallback(), this.addEventListener("invalid", this._onInvalid), document.addEventListener("click", (t) => this._handleDocumentClick(t)), document.addEventListener("DOMContentLoaded", () => {
      this.autoselectOff ? this._setSelectedElement() : this._setAutoSelectedFirstElement();
    });
  }
  updated(t) {
    super.updated(t), (t.has("value") || t.has("html")) && this.setValue(this.value), t.has("open") && this._checkingListPosition(), this.disabled && this.open && this._close(), t.has("searchText") && this._buttonSearchTextUpdate(), t.has("multiple") && this._updateHeadContent(), t.has("autoselectOff") && (this.autoselectOff ? this._setSelectedElement() : this._setAutoSelectedFirstElement());
  }
  render() {
...
I([
  n({ type: String, attribute: "input-placeholder" })
], E.prototype, "inputPlacholder", 2);
I([
  n({ type: String, reflect: !0 })
], E.prototype, "hint", 2);
I([
...
I([
  n({ type: Boolean, reflect: !0, attribute: "autoselect-off" })
], E.prototype, "autoselectOff", 2);
I([
  n({ type: Boolean, reflect: !0 })
], E.prototype, "reset", 2);
I([
...
I([
  n({ type: Boolean, reflect: !0 })
], E.prototype, "search", 2);
I([
  n({ reflect: !0, attribute: "custom-error" })
], E.prototype, "customError", 2);
I([
  n({ type: Boolean, reflect: !0, attribute: "static-error" })
], E.prototype, "staticError", 2);
I([
  S(".awc-select__input")
...
I([
  S(".awc-select-list")
], E.prototype, "optionList", 2);
I([
  S(".awc-select")
], E.prototype, "_selectHead", 2);
I([
  S(".awc-select__options")
], E.prototype, "_selectOptions", 2);
I([
  Y()
], E.prototype, "validationMessage", 2);
I([
  Y()
], E.prototype, "headContent", 2);
I([
  Y()
], E.prototype, "searchText", 2);
I([
  Y()
], E.prototype, "filteredOptions", 2);
I([
  Y()
], E.prototype, "isOptionListReverse", 2);
I([
  P("awc-select-search")
], E.prototype, "_onSearch", 2);
I([
  P("awc-create-option")
], E.prototype, "_onCreateOption", 2);
I([
  P("awc-select-change")
], E.prototype, "_onChangeSelect", 2);
E = I([
  f(ql)
], E);
const Hl = w`
...
var Zl = Object.defineProperty, Xl = Object.getOwnPropertyDescriptor, Bt = (t, e, r, i) => {
...
let wt = class extends u {
  constructor() {
    super(...arguments), this.text = "", this.placeholder = "", this.editing = !1, this.tabIndex = 0, this.color = "--colors-light-primary";
  }
  /**
   * Подключение колбэков обратного вызова для обработки событий.
   */
  connectedCallback() {
    super.connectedCallback(), this.addEventListener("focus", this.handleFocus), this.addEventListener("blur", this.handleBlur), this.addEventListener("dblclick", this.handleMouseDown);
  }
  /**
   ...
   */
  updated(t) {
    super.updated(t), t.has("editing") ? (this._renderEditMode(), this.contentElement && this.contentElement.focus()) : this._renderReadOnlyMode();
  }
  /**
...
Bt([
  P("awc-die-change")
], wt.prototype, "_onChange", 2);
Bt([
  P("awc-die-focus")
], wt.prototype, "_onFocus", 2);
Bt([
  P("awc-die-blur")
], wt.prototype, "_onBlur", 2);
Bt([
  S(".awc-die__content--edit")
], wt.prototype, "contentElement", 2);
wt = Bt([
  f("awc-die")
], wt);
const Kl = w`
...
`;
var Yl = Object.defineProperty, Jl = Object.getOwnPropertyDescriptor, cr = (t, e, r, i) => {
...
let he = class extends u {
  constructor() {
    super(...arguments), this.steps = 5, this.current = 2, this.stepColor = "--colors-light-primary", this._connected = !1;
  }
  connectedCallback() {
  ...
  _colorUpdater(t) {
    t && (this.stepColor.startsWith("--") ? t.style.cssText = `background-color: var(${this.stepColor})` : t.style.cssText = `background-color: ${this.stepColor}`);
  }
  _stepUpdater() {
    var r;
    if (!this._connected) return;
    let t = this.current;
    (isNaN(t) || t < 1) && (t = 1, this.current = t), ((r = this.shadowRoot) == null ? void 0 : r.querySelectorAll(".awc-stager__item")).forEach((i, o) => {
      const a = o + 1 < t + 1;
      i.classList.toggle("awc-stager__item--current", a) && this._colorUpdater(i);
    });
  }
  attributeChangedCallback(t, e, r) {
    super.attributeChangedCallback(t, e, r), t === "step-color" && r !== null && (this.stepColor = r, this._stepUpdater());
  }
  updated(t) {
  ...
  _renderProgress() {
    return Array.from(
      { length: this.steps },
      () => l`<div class="awc-stager__item"></div>`
    );
  }
};
he.styles = [Kl];
cr([
  n({ type: Number, reflect: !0 })
], he.prototype, "steps", 2);
cr([
  n({ type: Number, reflect: !0 })
], he.prototype, "current", 2);
cr([
  n({ type: String, attribute: "step-color" })
], he.prototype, "stepColor", 2);
cr([
  P("awc-stager-change")
], he.prototype, "_onChange", 2);
he = cr([
  f("awc-stager")
], he);
const Ql = w`
...
`;
var tc = Object.defineProperty, ec = Object.getOwnPropertyDescriptor, dr = (t, e, r, i) => {
...
let ue = class extends u {
  ...
  _checkedAwcAvatar() {
    this.slotElement.assignedNodes().filter((e) => e.nodeName.toLowerCase() === "awc-avatar").length === 1 ? this.chips.classList.add("awc-chips__avatar") : this.chips.classList.remove("awc-chips__avatar");
  }
  handleResetClick() {
...
ue.styles = [Ql];
dr([
  n({ type: Boolean, reflect: !0, attribute: "reset-button" })
], ue.prototype, "resetButton", 2);
dr([
  P("awc-chips-reset")
], ue.prototype, "_onRemoveChips", 2);
dr([
  S(".awc-chips")
], ue.prototype, "chips", 2);
dr([
  S("slot")
], ue.prototype, "slotElement", 2);
ue = dr([
  f("awc-chips")
], ue);
const rc = w`
...
`;
var oc = Object.defineProperty, ic = Object.getOwnPropertyDescriptor, It = (t, e, r, i) => {
...
let bt = class extends u {
  constructor() {
    super(...arguments), this.reverse = !1, this.status = "none", this.target = "_self", this.avatatColor = xi.GlobalBlue400;
  }
  render() {
    return this.href ? l`
...
It([
  n({ type: String, reflect: !0 })
], bt.prototype, "description", 2);
It([
  n({ type: Boolean, reflect: !0 })
], bt.prototype, "reverse", 2);
It([
  n({ type: String, reflect: !0, attribute: "avatar-status" })
], bt.prototype, "status", 2);
It([
  n({ type: String, attribute: "avatar-image" })
], bt.prototype, "avatarLink", 2);
It([
  n({ type: String })
], bt.prototype, "target", 2);
It([
  n({ type: String, attribute: "avatar-custom-color" })
], bt.prototype, "avatarCustomColor", 2);
It([
  n({ type: String })
], bt.prototype, "href", 2);
It([
  n({ type: String, attribute: "avatar-color" })
], bt.prototype, "avatatColor", 2);
bt = It([
  f("awc-user-info")
], bt);
const sc = w`
...
`;
var nc = Object.defineProperty, lc = Object.getOwnPropertyDescriptor, pr = (t, e, r, i) => {
...
pr([
  n({ type: String })
], ve.prototype, "position", 2);
ve = pr([
  f(Ki)
], ve);
var cc = Object.defineProperty, dc = Object.getOwnPropertyDescriptor, Yi = (t, e, r, i) => {
...
let Pr = class extends u {
  ...
  _combiningButtons(t) {
    ...
    let e = -1;
    t.forEach((r, i) => {
      i === 0 ? r.position = "first" : i === t.length - 1 ? r.position = "last" : (r.position = "inner", e = i);
...
`;
var uc = Object.defineProperty, vc = Object.getOwnPropertyDescriptor, hr = (t, e, r, i) => {
...
hr([
  P("awc-accordion-toggle")
], ge.prototype, "_onActive", 2);
ge = hr([
  f(Ji)
], ge);
const gc = w`
...
`;
var fc = Object.defineProperty, wc = Object.getOwnPropertyDescriptor, Co = (t, e, r, i) => {
...
let Ye = class extends u {
  ...
  _autocloseAccordionItem(t) {
    ...
    const e = t.target;
    e.disabled && this.disabled || (e.active ? (this.accordionItems.forEach((r) => r.active = !1), e.active = !0) : (e.active = !0, e.active && (e.active = !1)));
  }
  _handleAccordionItem(t) {
    this._autocloseAccordionItem(t);
  }
  _shutdownAllAccordionItems() {
    this.disabled ? this.accordionItems.forEach((t) => t.disabled = !0) : this.accordionItems.forEach((t) => t.disabled = !1);
  }
  updated(t) {
...
`;
var yc = Object.defineProperty, xc = Object.getOwnPropertyDescriptor, Qi = (t, e, r, i) => {
...
Qi([
  n({ type: String, reflect: !0 })
], Ar.prototype, "value", 2);
Ar = Qi([
  f(ts)
], Ar);
var Cc = Object.defineProperty, $c = Object.getOwnPropertyDescriptor, Tt = (t, e, r, i) => {
...
let _t = class extends kt(u) {
  constructor() {
    super(...arguments), this.name = "0", this.value = "0", this.marker = !1, this.min = 0, this.max = 100, this.step = 1;
  }
  get rangeItem() {
    return [...this.querySelectorAll(ts)];
  }
  updated(t) {
    super.updated(t), t.has("value") && this.setValue(this.value), t.has("marker") && this._setInputLabels();
  }
  _handleMarkers(t) {
    const e = t.target;
    e && (this.value = e.value, this.dispatchEvent(new Event("change", { composed: !0, bubbles: !0 })));
  }
  _handleInputValue(t) {
    const e = t.target;
  ...
  _setInputLabels() {
    const t = this._inputRange.getBoundingClientRect().width, e = parseFloat(this.value), r = this.rangeItem.length;
    this.rangeItem.forEach((i, o) => {
      const s = parseFloat(i.value);
      let a = 0;
      e >= this.min && e <= this.max ? a = Math.round(
        (s - this.min) / (this.max - this.min) * 100
      ) : e < this.min ? a = 0 : e > this.max && (a = 100);
      const d = t / (r - 1) * o, c = a - d / t;
      i.style.left = `${c}%`;
    });
  }
  connectedCallback() {
...
`;
var Oc = Object.defineProperty, Ec = Object.getOwnPropertyDescriptor, be = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Ec(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Oc(e, r, o), o;
};
...
let Rt = class extends u {
  constructor() {
    super(...arguments), this.value = 0, this.max = 100, this.label = "", this.hidePercent = !1;
  }
  _validateAndUpdateValues() {
    (isNaN(this.value) || this.value < 0) && (this.value = 0), (isNaN(this.max) || this.max < 0) && (this.max = 100), this.value > this.max && (this.value = this.max, this._onSuccesEvent()), this._updateFillerWidth();
  }
  _updateFillerWidth() {
...
be([
  n({ type: Boolean, reflect: !0, attribute: "hide-percent" })
], Rt.prototype, "hidePercent", 2);
be([
  P("awc-progress-bar-success")
], Rt.prototype, "_onSucces", 2);
be([
  S(".awc-progress-bar__filler")
], Rt.prototype, "fillerElement", 2);
Rt = be([
  f(Sc)
], Rt);
const Pc = w`
...
`;
var Ac = Object.defineProperty, Lc = Object.getOwnPropertyDescriptor, $o = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Lc(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
let Je = class extends u {
  ...
  _scalingIcon() {
    this.icons && this.icons.forEach((t) => {
      this.size === "large" ? t.iconScale = "78px" : t.iconScale = "48px";
    });
  }
  _setCurrentButtons() {
    this.buttons && this.buttons.forEach((t) => {
      this.size === "large" ? t.size = "large" : t.size = "regular", t.variant = "primary", t.background = "blue";
    });
  }
  updated(t) {
...
`;
var Tc = Object.defineProperty, Dc = Object.getOwnPropertyDescriptor, ko = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Dc(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Tc(e, r, o), o;
};
...
`;
var zc = Object.defineProperty, Rc = Object.getOwnPropertyDescriptor, Rr = (t, e, r, i) => {
...
let Ae = class extends u {
  ...
  pickTextColorBasedOnBgColor(t, e, r) {
    if (t) {
      ...
      const o = parseInt(i.substring(0, 2), 16), s = parseInt(i.substring(2, 4), 16), a = parseInt(i.substring(4, 6), 16);
      return o * 0.299 + s * 0.587 + a * 0.114 > 186 ? r : e;
    }
  }
  render() {
    const t = this.variant === "square" ? this.pickTextColorBasedOnBgColor(
      this.customColor,
...
Rr([
  n({ type: String, reflect: !0, attribute: "custom-color" })
], Ae.prototype, "customColor", 2);
Rr([
  n({ type: String, reflect: !0, attribute: "base-color" })
], Ae.prototype, "baseColor", 2);
Rr([
  n({ type: String, reflect: !0 })
...
`;
var qc = Object.defineProperty, Hc = Object.getOwnPropertyDescriptor, Dt = (t, e, r, i) => {
...
let mt = class extends kt(u) {
  constructor() {
    super(...arguments), this.reset = !1, this.BASE_PALETTE_COLORS = [
      "#ED3A3A",
      "#F74F4F",
      "#FB7C28",
      "#F8AF28",
  ...
  _handleColorSelection(t) {
    const e = t.target;
    if (!e) return;
    this.colorItems.forEach((i) => i.classList.remove("active-color")), e.classList.add("active-color");
    const r = e.getAttribute("value");
    r && (this.value = r.toLowerCase(), this._triggerChangeEvent(t), this._onChangeColor(this.value));
  }
  _setCustomColorValue(t) {
    this.value = this._inputColor.value;
  }
  _setDefaultColorInBasePalette() {
    this.colorItems.forEach((t) => t.classList.remove("active-color")), this.BASE_PALETTE_COLORS.forEach((t) => {
      this.value && t === this.value.toUpperCase() && this.colorItems.forEach((e) => {
  ...
  _checkAssignedAwcTabs() {
    ...
    this.tabs.forEach((e, r) => {
      e.active && (t = r), e.addEventListener("click", () => {
        this.activeTab = r;
      }), e.addEventListener("change", (i) => i.stopPropagation());
    }), t === -1 ? (this.tabs[0] && (this.tabs[0].active = !0), this.activeTab = 0) : this.activeTab = t, this._checkAwcTabsLength(), this.requestUpdate();
  }
  _checkAwcTabsLength() {
    this.tabs.length > 2 && console.warn("Maximum number of tabs exceeded");
  }
  _resetColorPicker() {
    this._inputColor.value = "#000000", this.value = "", this.dispatchEvent(new Event("change", { bubbles: !0, composed: !0 })), this.colorItems.forEach(
      (t) => t.classList.remove("active-color")
    );
  }
  updated(t) {
    super.updated(t), t.has("value") && this.setValue(this.value), this._setDefaultColorInBasePalette();
  }
  render() {
    const t = l`
      <svg
...
Dt([
  n({ type: Boolean, reflect: !0 })
], mt.prototype, "reset", 2);
Dt([
  n({ type: Array })
], mt.prototype, "BASE_PALETTE_COLORS", 2);
Dt([
  Y()
], mt.prototype, "activeTab", 2);
Dt([
  gi(".awc-color-picker__color")
], mt.prototype, "colorItems", 2);
Dt([
  S("input")
], mt.prototype, "_inputColor", 2);
Dt([
  S("slot")
], mt.prototype, "_slot", 2);
Dt([
  P("awc-color-picker-change")
], mt.prototype, "_onChangeColor", 2);
mt = Dt([
  f(Uc)
], mt);
const Nc = w`
...
`;
var Wc = Object.defineProperty, Gc = Object.getOwnPropertyDescriptor, Zc = (t, e, r, i) => {
...
`;
var Yc = Object.defineProperty, Jc = Object.getOwnPropertyDescriptor, qt = (t, e, r, i) => {
...
let $t = class extends u {
  ...
  _changeBackgroundIconModule() {
    this._iconSlot.assignedElements().filter((r) => r.type === "module").length ? this._isModuleIcon = !0 : this._isModuleIcon = !1;
  }
  render() {
    const t = Q`
...
qt([
  n({ type: String, reflect: !0, attribute: "icon-color" })
], $t.prototype, "iconColor", 2);
qt([
  n({ type: Boolean, reflect: !0 })
], $t.prototype, "arrow", 2);
qt([
  S("slot[name='icon']")
], $t.prototype, "_iconSlot", 2);
qt([
  Y()
], $t.prototype, "_isModuleIcon", 2);
$t = qt([
  f(Qc)
], $t);
const td = w`
...
`;
var ed = Object.defineProperty, rd = Object.getOwnPropertyDescriptor, Oo = (t, e, r, i) => {
...
Oo([
  n({ type: String, reflect: !0 })
], tr.prototype, "effect", 2);
Oo([
  n({ type: String, reflect: !0 })
], tr.prototype, "rounded", 2);
tr = Oo([
  f(od)
], tr);
const id = w`
...
`;
var sd = Object.defineProperty, ad = Object.getOwnPropertyDescriptor, Be = (t, e, r, i) => {
...
let Xt = class extends u {
  constructor() {
    super(...arguments), this._activePage = 1, this._itemsPerPage = 1, this._totalItemsCount = 1, this.first = !1, this.last = !1, this._maxVisibleItems = 5, this._ellipsisVisible = !1;
  }
  get activePage() {
    return this._activePage;
  }
  set activePage(t) {
    const e = Math.ceil(this._totalItemsCount / this._itemsPerPage), r = Math.min(Math.max(1, t || 1), e), i = this._activePage;
  ...
  set itemsPerPage(t) {
    const e = Math.max(1, t || 1), r = this._itemsPerPage;
  ...
  set totalItemsCount(t) {
    const e = Math.max(1, t || 1), r = this._totalItemsCount;
    e !== r && (this._totalItemsCount = e, this.requestUpdate("totalItemsCount", r));
  }
  _generatePages(t) {
    const e = [], r = Math.floor(this._maxVisibleItems / 2);
    let i = Math.max(1, this.activePage - r), o = Math.min(t, this.activePage + r);
    this.activePage <= r ? o = Math.min(t, this._maxVisibleItems) : this.activePage > t - r && (i = Math.max(1, t - this._maxVisibleItems + 1)), t === o && this._maxVisibleItems !== t && (t && o && i) !== 1 && (e.push(1), e.push("..."), this._ellipsisVisible = !0);
    for (let s = i; s <= o; s++)
      e.push(s);
    return this._maxVisibleItems === o && this._maxVisibleItems !== t && (this._ellipsisVisible = !0, e.push("..."), e.push(t)), e;
  }
  _nextPage() {
  ...
  _onPageClick(t) {
    typeof t == "number" && t === this.activePage || typeof t == "number" && (this.activePage = t, this._onChange());
  }
  _handleKeydown(t) {
    var e;
    if (t.key === "Enter" || t.key === " ") {
      const r = (e = this.shadowRoot) == null ? void 0 : e.activeElement;
      if (r != null && r.classList.contains("awc-pagination__button--prev"))
        this._previousPage();
      else if (r != null && r.classList.contains("awc-pagination__button--next"))
        this._nextPage();
      else if (r != null && r.classList.contains("awc-pagination__button--first"))
        this._firstPage();
      else if (r != null && r.classList.contains("awc-pagination__button--last"))
        this._lastPage();
      else {
  ...
  render() {
    const t = Math.ceil(this.totalItemsCount / this.itemsPerPage), e = this._generatePages(t), r = l`
...
Xt.styles = [id];
Be([
  n({ type: Number, reflect: !0, attribute: "active-page" })
], Xt.prototype, "activePage", 1);
Be([
  n({ type: Number, reflect: !0, attribute: "items-per-page" })
], Xt.prototype, "itemsPerPage", 1);
Be([
  n({ type: Number, reflect: !0, attribute: "total-items-count" })
], Xt.prototype, "totalItemsCount", 1);
Be([
  n({ type: Boolean, reflect: !0 })
], Xt.prototype, "first", 2);
Be([
  n({ type: Boolean, reflect: !0 })
], Xt.prototype, "last", 2);
Xt = Be([
...
`;
var cd = Object.defineProperty, dd = Object.getOwnPropertyDescriptor, pd = (t, e, r, i) => {
...
`;
var vd = Object.defineProperty, gd = Object.getOwnPropertyDescriptor, Yt = (t, e, r, i) => {
...
let St = class extends u {
  constructor() {
    super(...arguments), this.opened = !1, this._isEmtyButtonSlot = !0, this._html = document.querySelector("html"), this._keyClosing = this._handleKeyClosing.bind(this), this._clickOutside = this._handleClickOutside.bind(this);
  }
  get tabsGroup() {
    return this.querySelector(bi);
  }
  ...
  _toggleScrollLock() {
    this.opened ? this._html.style.overflow = "hidden" : this._html.style.removeProperty("overflow");
  }
  _disableTabsDivider() {
    this.tabsGroup && (this.tabsGroup.noDivider = !0);
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("keydown", this._keyClosing), this.addEventListener("click", this._clickOutside), document.addEventListener("DOMContentLoaded", () => {
      this._checkSlottedButton();
    });
  }
  disconnectedCallback() {
    super.disconnectedCallback(), window.removeEventListener("keydown", this._keyClosing), this.removeEventListener("click", this._clickOutside);
  }
  updated(t) {
    super.updated(t), t.has("opened") && (this._toggleScrollLock(), this._disableTabsDivider(), this._checkSlottedButton(), this.opened && this.open());
  }
  get awcButtons() {
    return [...this.querySelectorAll("awc-button")];
  }
  _checkSlottedButton() {
    this.awcButtons.filter((e) => e.getAttribute("slot") === "awc-modal-button").length ? this._isEmtyButtonSlot = !1 : (this._isEmtyButtonSlot = !0, this.description = "");
  }
  /**
...
Yt([
  n({ type: Boolean, reflect: !0 })
], St.prototype, "opened", 2);
Yt([
  gi("slot[name='awc-modal-button']")
], St.prototype, "slottedButtons", 2);
Yt([
  Y()
], St.prototype, "_isEmtyButtonSlot", 2);
Yt([
  P("awc-modal-open")
], St.prototype, "_modalOpenEvent", 2);
Yt([
  P("awc-modal-close")
], St.prototype, "_modalCloseEvent", 2);
St = Yt([
  f(fd)
], St);
const wd = w`
...
`;
var bd = Object.defineProperty, _d = Object.getOwnPropertyDescriptor, yt = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? _d(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && bd(e, r, o), o;
};
const md = "awc-popover", yd = {
  XXS: "2",
  XS: "4",
  S: "8",
  SM: "12",
...
let at = class extends u {
  constructor() {
    super(...arguments), this.position = "top", this.spacing = "S", this.strategy = "absolute", this.triggerType = "click", this.active = !1, this.disabled = !1, this.noPadding = !1, this.popperInstance = null, this._hoverTimeout = null;
  }
  connectedCallback() {
  ...
  _createPopperInstance() {
    this._nestedElement && this._popover && (this.popperInstance = xo(this._nestedElement, this._popover, {
      placement: this.position,
      modifiers: [{
        name: "offset",
  ...
  _onFocusOut() {
    !this.disabled && !this.contains(document.activeElement) && (this.active = !1, this._removeOutsideClickHandler());
  }
  _onMouseEnter() {
    this.disabled || (this._hoverTimeout && (clearTimeout(this._hoverTimeout), this._hoverTimeout = null), this.active = !0);
  }
  _onMouseLeave() {
    !this.disabled && this.triggerType === "hover" && (this._hoverTimeout = window.setTimeout(() => {
      this.active = !1;
    }, 200));
  }
  updated(t) {
    super.updated(t), t.has("active") && (this.active ? (this._createPopperInstance(), this._popoverOpenEvent(this.active)) : (this._destroyPopperInstance(), this._popoverCloseEvent(this.active))), (t.has("triggerType") || t.has("disabled")) && this._updateEventListeners();
  }
  _updateEventListeners() {
    if (this._nestedElement.removeEventListener("click", this._setupPopover.bind(this)), this._nestedElement.removeEventListener("mouseover", this._setupPopover.bind(this)), this._nestedElement.removeEventListener("mouseleave", this._onMouseLeave.bind(this)), this._nestedElement.removeEventListener("focusin", this._onFocusIn.bind(this)), this._nestedElement.removeEventListener("focusout", this._onFocusOut.bind(this)), this._popover.removeEventListener("mouseenter", this._onMouseEnter.bind(this)), this._popover.removeEventListener("mouseleave", this._onMouseLeave.bind(this)), !this.disabled)
      switch (this.triggerType) {
        case "click":
          this._nestedElement.addEventListener("click", this._setupPopover.bind(this));
          break;
        case "hover":
          this._nestedElement.addEventListener("mouseover", this._onMouseEnter.bind(this)), this._nestedElement.addEventListener("mouseleave", this._onMouseLeave.bind(this)), this._popover.addEventListener("mouseenter", this._onMouseEnter.bind(this)), this._popover.addEventListener("mouseleave", this._onMouseLeave.bind(this));
          break;
        case "focus":
          this._nestedElement.addEventListener("focusin", this._onFocusIn.bind(this)), this._nestedElement.addEventListener("focusout", this._onFocusOut.bind(this));
          break;
      }
  }
  render() {
...
yt([
  n({ type: String, reflect: !0 })
], at.prototype, "spacing", 2);
yt([
  n({ type: String, reflect: !0 })
], at.prototype, "strategy", 2);
yt([
  n({ type: String, reflect: !0, attribute: "trigger-type" })
], at.prototype, "triggerType", 2);
yt([
  n({ type: Boolean, reflect: !0 })
...
yt([
  n({ type: Boolean, reflect: !0, attribute: "no-padding" })
], at.prototype, "noPadding", 2);
yt([
  P("awc-popover-open")
], at.prototype, "_popoverOpenEvent", 2);
yt([
  P("awc-popover-close")
], at.prototype, "_popoverCloseEvent", 2);
yt([
  S(".awc-popover")
], at.prototype, "_popover", 2);
yt([
  S(".awc-popover__nested")
], at.prototype, "_nestedElement", 2);
at = yt([
  f(md)
], at);
var xd = Object.defineProperty, Cd = Object.getOwnPropertyDescriptor, $d = (t, e, r, i) => {
...
`;
var Ed = Object.defineProperty, Sd = Object.getOwnPropertyDescriptor, Jt = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Sd(e, r) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Ed(e, r, o), o;
};
const Pd = "awc-dialog", si = {
  infoIcon: Q`
...
let Pt = class extends u {
  constructor() {
    super(...arguments), this.variant = "info", this.opened = !1, this._clickOutside = this._handleClickOutside.bind(this);
  }
  _handleClickOutside(t) {
  ...
  _lockBody() {
    ...
    this.opened ? (t.style.overflow = "hidden", t.style.touchAction = "none") : (t.style.removeProperty("overflow"), t.style.removeProperty("touch-action"));
  }
  _onInert() {
    const t = (e) => {
      e.parentNode && (Array.from(e.parentNode.childNodes).forEach((r) => {
  ...
  connectedCallback() {
    super.connectedCallback(), this.addEventListener("click", this._clickOutside), document.addEventListener("DOMContentLoaded", () => {
      this.opened ? (this._setCurrentStyleAwcButtonInSlot(), this._onInert()) : this._removeInert();
    });
  }
  disconnectedCallback() {
  ...
  updated(t) {
    super.updated(t), t.has("opened") && (this.opened ? (this._setCurrentStyleAwcButtonInSlot(), this._onInert()) : this._removeInert(), this._lockBody());
  }
  render() {
...
Jt([
  n({ type: Boolean, reflect: !0 })
], Pt.prototype, "opened", 2);
Jt([
  P("awc-dialog-open")
], Pt.prototype, "_onOpening", 2);
Jt([
  P("awc-dialog-close")
], Pt.prototype, "_onClosing", 2);
Jt([
  S("slot[name='awc-dialog-button']")
], Pt.prototype, "_slotButtons", 2);
Pt = Jt([
  f(Pd)
], Pt);
const Ad = w`
...
`;
var Ld = Object.defineProperty, Bd = Object.getOwnPropertyDescriptor, Qt = (t, e, r, i) => {
...
let At = class extends u {
  constructor() {
    super(...arguments), this.flexDirection = "row", this.alignItems = "start", this.gap = "s", this.isInline = !1, this.fullWidth = !1;
  }
  render() {
    return l`<slot></slot>`;
  }
...
], At.prototype, "flexDirection", 2);
Qt([
  n({ type: String, reflect: !0, attribute: "align-items" })
], At.prototype, "alignItems", 2);
Qt([
  n({ type: String, reflect: !0, attribute: "justify-content" })
], At.prototype, "justifyContent", 2);
Qt([
  n({ type: String, reflect: !0 })
], At.prototype, "gap", 2);
Qt([
  n({ type: String, reflect: !0, attribute: "flex-wrap" })
], At.prototype, "flexWrap", 2);
Qt([
  n({ type: Boolean, reflect: !0, attribute: "inline-flex" })
], At.prototype, "isInline", 2);
Qt([
  n({ type: Boolean, reflect: !0, attribute: "full-width" })
], At.prototype, "fullWidth", 2);
At = Qt([
  f(Id)
], At);
export {
