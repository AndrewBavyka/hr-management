...
const handleSubmit = () => {
    ...
    axios.post('/api/employee/personal-info', formData)
        .then(response => {
...
<template>
    <form @submit.prevent="handleSubmit">
        <AppInput type="file" placeholder="UserPhoto" v-model="formData.userPhoto" />
        ...
        <div class="form__wrapper">
            <awc-stack full-width gap="l">
                <awc-stack gap="l" full-width flex-direction="column">
                    ...
                    <AppSelect v-model="formData.gender" placeholder="Gender" autoselect-off
                        :options="['Male', 'Female', 'Other']" />
                </awc-stack>

                <awc-stack gap="l" full-width flex-direction="column">
                    <AppInput name="lastName" type="text" placeholder="Last Name" v-model="formData.lastName" />
            ...
            <awc-stack align-items="center" justify-content="space-between" full-width>
                <AppSelect v-model="formData.city" placeholder="City" :options="['City A', 'City B', 'City C']" />
                <AppSelect v-model="formData.state" placeholder="State" :options="['State X', 'State Y', 'State Z']" />
                <AppSelect v-model="formData.zipCode" placeholder="ZIP Code"
